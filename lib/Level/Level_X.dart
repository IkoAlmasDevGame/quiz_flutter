...
class Level_X_ extends StatefulWidget {
  @override
  Level_X_State createState() => Level_X_State();
}

class Level_X_State extends State<Level_X_> {
  List qList = [
    Quiz("1. ", "", "", "", "", 1),
    Quiz("2. ", "", "", "", "", 2),
    Quiz("3. ", "", "", "", "", 3),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Level - 10', style: TextStyle(),
        ),
        centerTitle: true,
