...
class Level_XV_ extends StatefulWidget {
  @override
  Level_XV_State createState() => Level_XV_State();
}

class Level_XV_State extends State<Level_XV_> {
  List qList = [
    Quiz("1. ", "", "", "", "", 1),
    Quiz("2. ", "", "", "", "", 2),
    Quiz("3. ", "", "", "", "", 3),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Level - 15', style: TextStyle(),
        ),
        centerTitle: true,
