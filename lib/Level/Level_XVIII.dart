...
class Level_XVIII_ extends StatefulWidget {
  @override
  Level_XVIII_State createState() => Level_XVIII_State();
}

class Level_XVIII_State extends State<Level_XVIII_> {
  List qList = [
    Quiz("1. ", "", "", "", "", 1),
    Quiz("2. ", "", "", "", "", 2),
    Quiz("3. ", "", "", "", "", 3),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Level - 18', style: TextStyle(),
        ),
        centerTitle: true,
